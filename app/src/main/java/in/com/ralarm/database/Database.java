 ...
 */
package in.com.ralarm.database;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String COLUMN_DATE = "alarm_date";
	...
	public static long create(Alarm alarm) {
		...
		try {
			...
			System.out.println("dbs=="+alarm.getDays().toString()+"=="+str);
		...
		System.out.println("dbs==inset"+cv.toString());
		
		return getDatabase().insert(ALARM_TABLE, null, cv);
	}
	public static int update(Alarm alarm) {

		System.out.println("aka===Database updated called ====="+alarm.getAlarmName());
		ContentValues cv = new ContentValues();
		cv.put(COLUMN_ALARM_ACTIVE, alarm.getAlarmActive());
		cv.put(COLUMN_ALARM_TIME, alarm.getAlarmTimeString());
